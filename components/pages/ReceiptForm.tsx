        ...
        <form onSubmit={handleSubmit}>
            ...
            <Card>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    {/* Column 1 */}
                    <div>
                        <label htmlFor="receiptNumber" className="block text-sm font-medium text-slate-700">{t('receiptNo')}</label>
                     ...
                     <div>
                        <label htmlFor="from" className="block text-sm font-medium text-slate-700">{t('clientVendor')}</label>
                    ...
                    <div>
                        <label htmlFor="amount" className="block text-sm font-medium text-slate-700">{t('amount')}</label>
                    ...
                    {/* Column 2 */}
                    <div>
                        <label htmlFor="date" className="block text-sm font-medium text-slate-700">{t('transactionDate')}</label>
                    ...
                    <div>
                        <label htmlFor="paymentMethod" className="block text-sm font-medium text-slate-700">{t('paymentMethod')}</label>
                    ...
                    <div className="md:col-span-2">
                        <label htmlFor="photoUrl" className="block text-sm font-medium text-slate-700">{t('photoReceipt')}</label>
                        <input type="text" name="photoUrl" id="photoUrl" value={receipt.photoUrl || ''} onChange={handleInputChange} placeholder={t('photoUrl')} className="mt-1 block w-full input"/>
